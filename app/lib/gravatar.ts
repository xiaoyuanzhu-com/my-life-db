...
/**
 * Synchronous version that generates a Gravatar URL using MD5 hash
 * Gravatar requires MD5 hashes of the email address
 */
...
function md5(string: string): string {
  ...
  function convertToWordArray(str: string): number[] {
    ...
    const wordArray: number[] = new Array(numberOfWords).fill(0);
    let bytePosition = 0;
    let byteCount = 0;
